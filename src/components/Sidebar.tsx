...
export default function Sidebar({
  ...
  return (
    <aside className="absolute top-4 left-4 w-[36rem] max-h-[calc(100vh-2rem)] bg-white/15 backdrop-blur-xl border border-white/30 shadow-2xl rounded-2xl flex flex-col overflow-hidden">
      {/* Header */}
